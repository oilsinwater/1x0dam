...
// this will be aliased by webpack at runtime (this is just for typing)
const resolved_router_1 = tslib_1.__importDefault(require("./resolved-router"));
...
const RouterDecorator = (Story, context) => {
    ...
    resolved_router_1.default.router = Object.assign(Object.assign(Object.assign({}, defaultRouter), { locale: (_b = context === null || context === void 0 ? void 0 : context.globals) === null || _b === void 0 ? void 0 : _b.locale }), nextRouterParams);
    return (
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (0, jsx_runtime_1.jsx)(resolved_router_context_1.RouterContext.Provider, Object.assign({ value: resolved_router_1.default.router }, { children: (0, jsx_runtime_1.jsx)(Story, {}) })));
};
