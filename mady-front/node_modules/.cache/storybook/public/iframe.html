    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./components","files":"**/*.stories.mdx","importPathMatcher":"^\\.[\\\\/](?:components(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.mdx)$"},{"titlePrefix":"","directory":"./components","files":"**/*.stories.@(js|jsx|ts|tsx)","importPathMatcher":"^\\.[\\\\/](?:components(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|ts|tsx))$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:6006/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors-node_modules_storybook_addon-actions_preview_js-generated-config-entry_js-node_module-11f7f7.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>